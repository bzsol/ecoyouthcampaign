      ...
      en: {
        translation: {
          ...
          workshop: {
            ...
            fourth_text: 'Lets Do It, Romania! Colegiul Economic al Banatului Montan Reșita participated this year for a new edition of the National Cleanup Day that took place on September 16, together with 191 other countries that had the same mission: a world with less waste."Lets Do It, Romania!" is the largest social involvement project in Romania, which aims to clean up waste from natural areas in a single day.Project volunteers mobilized high school students to carry out this ecological activity. Why did our school participate? – Because we wanted to have a cleaner neighborhood and city. Because we are convinced that only through the power of example you can contribute to changing society for the better.'
          }
        }
      },
      hu: {
